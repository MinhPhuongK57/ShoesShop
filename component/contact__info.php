		...
		<div class="wrap">
			<div class="contact-grids">
				<div class="col_1_of_bottom span_1_of_first1">
					...
					<ul class="list3">
						<li>
							<img src="<?php echo $level . img__path . 'home.png' ?>" alt="">
				...
				<div class="col_1_of_bottom span_1_of_first1">
					...
					<ul class="list3">
						<li>
							<img src="<?php echo $level . img__path . 'phone.png' ?>" alt="">
							<div class="extra-wrap">
								<p><span>Telephone:</span>+1 800 258 2598</p>
							</div>
							<img src="<?php echo $level . img__path . 'fax.png' ?>" alt="">
							<div class="extra-wrap">
				...
				<div class="col_1_of_bottom span_1_of_first1">
					...
					<ul class="list3">
						<li>
							<img src="<?php echo $level . img__path . 'email.png' ?>" alt="">
							<div class="extra-wrap">
