...
<head>
	...
	<!---//move-top-top---->
	<!-- Owl Carousel Assets -->
	<link href="<?php echo $level.css__path.'owl.carousel.css' ?>" rel="stylesheet">
	<script src="<?php echo $level.js__path.'jquery-1.9.1.min.js' ?>"></script>
	<!-- Owl Carousel Assets -->
	<!-- Prettify -->
	<script src="<?php echo $level.js__path.'owl.carousel.js' ?>"></script>
	<script>
		$(document).ready(function () {
